...
public class UserDaoImpl {
	...
	public User phologin(Object[] obj){
		String sql = "select * from dt_user where telphone=?";
		ArrayList<HashMap<String, Object>> list = odbcUtils.executeQuery(sql, obj);
		odbcUtils.close();
		User user = null;
		if (list.size()>0) {
	...
	public int register(User user) {
		int i = 0;
		String sql = "insert into dt_user(password,email,picture,state) values (?,?,?,?)";
		Object [] params={user.getPassword(),user.getEmail(),"liyunlong.jpg",1};
