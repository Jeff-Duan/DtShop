	...
	<body class="easyui-layout">
		<div data-options="region:'north',border:false" style="height:60px" frameborder="no" scrolling="no">
			<div class="header" frameborder="no" scrolling="no">
				 <div class="logo" >
					<img src="${pageContext.request.contextPath}/static/img/after/logo5.png"  title="梦之队" />
		
				</div>
				<div style="float: right">
					<div style=" float: left;padding-right: 30px;padding-top: 10px"><iframe allowtransparency="true" frameborder="0" width="180" height="36" scrolling="no" src="//tianqi.2345.com/plugin/widget/index.htm?s=3&z=2&t=0&v=0&d=3&bd=0&k=&f=ffffff&q=1&e=1&a=1&c=54511&w=180&h=36&align=center"></iframe></div>
					...
					<div class="easyui-panel" style="width: 120px;height:60px;background:#438EB9;" data-options="border:false">
						<img src="${pageContext.request.contextPath}/static/img/mainimg/${manager.photo}" style="border-radius: 25px;border: none" height="40px" width="40px"/>
				...
				<div id="mm2" class="menu-content" style="width:100px;color: white;background-color: #438EB9;border: none;">
					...
					<ul class="menu-children" >
						<li>
							<a class="wu" style="color: white;" href="${pageContext.request.contextPath}/queryManagerInfoServlet?managerid=${manager.managerid}&permission=${manager.permission}" title="个人信息" target="main">个人信息</a>
						</li>
						<li>
							<a class="wu" style="color: white;" href="${pageContext.request.contextPath}/queryManagerInfoServlet?managerid=${manager.managerid}&permission=${pp}" title="修改信息" target="main">修改信息</a>
						</li>
						<li>
							<a class="wu" style="color: white;" href="${pageContext.request.contextPath}/AfterJsp/afterlogin.jsp" title="安全退出" target="_blank" target=top >安全退出</a>
						</li>
					</ul>
		...
		<div data-options="region:'west',border:false" style="width:200px; background-color: #FFFFFF;overflow: hidden">
			...
			<div class="menu-list">
				<a href="${pageContext.request.contextPath}/CountAllServlet" target="main" class="block menu-list-title center" style="color:#2B7DBC;">起始页</a>
				<ul>
					...
					<li>
						<ul class="menu-children">
							...
							<li>
								<a href="${pageContext.request.contextPath}/queryGoodTypeServlet" title="商品添加" target="main">添加商品</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/AfterJsp/add_product_type.jsp" title="添加商品类型" target="main">添加商品类型</a>
							</li>
							<li>
					...
					<li>
						<ul class="menu-children">
							<li>
								<a href="${pageContext.request.contextPath}/QueryUserServlet?page=1&rows=10" title="会员列表" target="main">用户列表</a>
							</li>
					...
					<li>
						<ul class="menu-children">
							<li><a href="http://www.mi.com" target="_blank">合作企业</a></li>
							<li><a href="http://www.mi.com" target="_blank">联系我们</a></li>
							</ul>
					</li>
				</ul>
