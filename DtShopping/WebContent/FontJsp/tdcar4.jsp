...
<body>
	...
	<%
	Pinglun car[] = (Pinglun[]) request.getAttribute("ping");
	%>
		<div id="pinlun" >
			<%
			...
			%>
				<div class="plkuang">
					<div id="A">
						<img src="/DtShopping/static/img/after/<%=cc.getGoodimg()%>" height="100px"
					...
					<div id="B">
						...
						<div id="xiangqing">
							<span style="margin-left: 400px;"><%=cc.getGoodtime()%></span>
						</div>
					</div>
